...
{/* ----------------------- */}
        ...
        <button className="inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden" type="button" >
          <svg
